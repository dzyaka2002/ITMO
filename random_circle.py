...
draw.point((start_x, start_y), fill='white')
draw.point((start_x+4, start_y), fill='white')
draw.point((start_x+4, start_y+4), fill='white')
draw.point((start_x, start_y+4), fill='white')
for i in range (4):
